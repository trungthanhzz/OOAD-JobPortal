...
<head>
	...
	<title>Jobs Portal - Công ty</title>
											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="background" class="bootstrap3-wysihtml5 form-control" placeholder="Nội dung ..." style="height: 200px;"><?php echo "$desc"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label>Dịch vụ</label>
														<textarea name="services" class="bootstrap3-wysihtml5 form-control" placeholder="Nội dung ..." style="height: 200px;"><?php echo "$myserv"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="expertise" class="bootstrap3-wysihtml5 form-control" placeholder="Nội dung ..." style="height: 200px;"><?php echo "$myex"; ?></textarea>
													</div>
